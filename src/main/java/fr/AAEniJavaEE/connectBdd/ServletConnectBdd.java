package fr.AAEniJavaEE.connectBdd;
...
/**
 * Servlet implementation class ServletConnectBdd
 */
@WebServlet("/ServletConnectBdd")
public class ServletConnectBdd extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
	  /**
     * @see HttpServlet#HttpServlet()
     */
    public ServletConnectBdd() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			out.print("La connexion du projet enchere est "+ (cnx.isClosed()?"fermée":"ouverte")+".");
